...
class Run extends Command
{
     ...
     * @var string
     */
    protected $description = 'The main command.';
    ...
    public function handle()
    {
        ...
        $discord->listenCommand('zoo', function (Interaction $interaction) use ($discord) {
            ...
            $interaction->showModal(
                ...
                function (Interaction $interaction, Collection $components) use ($discord) {
                    ...
                    foreach ($this->activityTypes() as $type => $item) {
                        ...
                        $this->buttons[] = $btn;
                        $btn->setListener($this->addButtonListener($components, $discord), $discord, true);
        ...
        $discord->listenCommand('zoodelete', function (Interaction $interaction) use ($discord) {
